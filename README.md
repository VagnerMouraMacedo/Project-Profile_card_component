...
Seu desafio é criar esse componente de cartão de perfil e fazer com que pareça o mais próximo possível do design.
...
YA OU encontrará todos os ativos necessários na pasta `/imagens`.Os ativos já estão otimizados.
